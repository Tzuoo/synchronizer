...
test("跨站總帳每個玩法顯示各站加總過程", () => {
  ...
  assert.doesNotMatch(html, /@media\(max-width:800px\)\{\.ledger-table \.ledger-winning/);
  assert.match(html, /#betsTable tbody td:nth-child\(1\)/);
  assert.doesNotMatch(html, /[},]tbody td:nth-child\(1\)/);

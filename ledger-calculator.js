(() => {
  ...
  if (!demo) return;
  const style = document.createElement('style'); style.textContent = '.ledger-calculator{margin-bottom:16px}.ledger-calc-body{padding:14px;display:grid;gap:12px}.ledger-calc-options{display:flex;flex-wrap:wrap;gap:8px}.ledger-calc-options label{padding:6px 9px;border:1px solid var(--line);border-radius:8px}.ledger-calc-options input[type=number]{width:82px;margin-left:6px;background:var(--bg);color:var(--text);border:1px solid var(--line);border-radius:4px}.ledger-calc-result{display:grid;gap:12px}.ledger-calc-game{display:grid;gap:10px;padding:12px;border:1px solid var(--line);border-radius:10px;background:rgba(255,255,255,.018)}.ledger-calc-game-title{font-weight:800;color:var(--text)}.ledger-calc-summary{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.ledger-calc-summary>div{padding:9px 10px;border-radius:8px;background:var(--bg);border:1px solid var(--line)}.ledger-calc-summary small{display:block;color:var(--muted);font-size:12px}.ledger-calc-summary b{display:block;margin-top:2px;color:var(--text);font-size:18px;font-variant-numeric:tabular-nums}.ledger-calc-summary .calc-multiplier b{color:var(--yellow)}.ledger-calc-table{width:100%;border-collapse:collapse;font-variant-numeric:tabular-nums}.ledger-calc-table th,.ledger-calc-table td{padding:8px 9px;border-bottom:1px solid var(--line);text-align:right}.ledger-calc-table th:first-child,.ledger-calc-table td:first-child{text-align:left}.ledger-calc-table th{color:var(--muted);font-size:12px;font-weight:600}.ledger-calc-table td:last-child{color:var(--yellow);font-weight:800}.ledger-calc-details{color:var(--muted);font-size:13px}.ledger-calc-details summary{cursor:pointer;color:var(--blue);width:max-content}.ledger-calc-detail-lines{display:grid;gap:3px;padding:8px 0 0;line-height:1.55}@media(max-width:640px){.ledger-calc-summary{grid-template-columns:1fr}.ledger-calc-table th,.ledger-calc-table td{padding:7px 5px;font-size:13px}}'; document.head.append(style);
  ...
  const refresh = () => {
    ...
    for (const game of new Set(selected.map(row => row.game))) {
      ...
      const block = document.createElement('section'); block.className = 'ledger-calc-game';
